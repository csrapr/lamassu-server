...
const resolvers = {
  ...
  Query: {
    ...
    erc20tokens: () => erc20token.getERC20Tokens()
  },
  Mutation: {
    machineAction: (
    ...
    /*     addERC20Token: (...[, { contractAddress, coinName, tickerSymbol }]) =>
      erc20tokens.addERC20Token(contractAddress, coinName, tickerSymbol) */
  }
}
